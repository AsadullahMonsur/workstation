...
public class Rent_Frag2_Content_Info {
    ...
    public Rent_Frag2_Content_Info() {
    }

    public Rent_Frag2_Content_Info(int user_mode, Image_File profile_img, String rent_id, String location, Amount amount, Contact contact_number, String description, int isActive, int is_published, int is_rented, String publish_date, String rent_date, double user_rating, List<Image_File> img_list) {
    ...
    public String toString() {
        return "Rent_Frag2_Content_Info{" +
                "user_mode=" + user_mode +
