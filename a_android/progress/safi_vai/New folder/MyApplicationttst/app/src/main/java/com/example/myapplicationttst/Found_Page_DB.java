...
public class Found_Page_DB extends AppCompatActivity implements Runnable {
    ...
    public Found_Page_DB() {
    }

    public Found_Page_DB(Found_Page_Data lpd) {
    ...
    public void run() {
        try{
            ...
            String query    = "insert into found_page values(null,'"+prod+"','"+loc+"','"+imei+"')";
