...
public class Owner_Add_Player_Adapter
        extends RecyclerView.Adapter<Owner_Add_Player_Adapter.ViewHolder> {
    private Context context;
    private String []conInfo;
    private int flag = 0;

    public Owner_Add_Player_Adapter(Context context, String[] conInfo) {
    ...
    @NonNull
    @Override
    public Owner_Add_Player_Adapter.ViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        LayoutInflater layoutInflater = LayoutInflater.from(parent.getContext());
        View itemView = layoutInflater.inflate(R.layout.owner_content5_card,
                parent, false);
        return new Owner_Add_Player_Adapter.ViewHolder(itemView);
    }

    @Override
    public void onBindViewHolder(@NonNull Owner_Add_Player_Adapter.ViewHolder holder, int position) {
    ...
    private void execute_command(Context context, Owner_Add_Player_Adapter.ViewHolder holder) {
        if(holder.id_input.getText().toString().equals("") ||
                ...
                holder.position_input.getText().toString().equals("")||
                    ...
                    .addValueEventListener(new ValueEventListener() {
                        ...
                        public void onDataChange(DataSnapshot dataSnapshot) {
                            if (dataSnapshot.exists()) {
                                if(flag==0) {
                                    notification(context, "Player ID already exists");
                                }
                            }
                            else {
                                flag = 1;
                                ...
                                User_Info user_info = new User_Info(
                                        ...
                                        holder.age_input.getText().toString(),
                                        holder.position_input.getText().toString(),3);
                                ...
                                dBR.child("official_users")
                                        ...
                                        .addOnCompleteListener(new OnCompleteListener<Void>() {
                                            ...
                                            public void onComplete(@NonNull Task<Void> task) {
                                                ...
                                                holder.position_input.getText().clear();
                                            }
        ...
        holder.position_input.invalidate();
    ...
    public static class ViewHolder extends RecyclerView.ViewHolder {
        ...
        public ViewHolder(@NonNull View itemView) {
            ...
            id_input = itemView.findViewById(R.id.owner_cont5_input1);
            name_input = itemView.findViewById(R.id.owner_cont5_input2);
            country_input = itemView.findViewById(R.id.owner_cont5_input3);
            age_input = itemView.findViewById(R.id.owner_cont5_input4);
            position_input = itemView.findViewById(R.id.owner_cont5_input5);
            password_input = itemView.findViewById(R.id.owner_cont5_input6);
            submit = itemView.findViewById(R.id.owner_cont5_btn);
        }
    }
