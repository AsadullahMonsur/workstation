...
public class Rotation_Mouse extends Application {
...
//        Parent root = FXMLLoader.load(getClass().getResource("sample.fxml"));
        ...
        initialize_mouse_controll(group_01,scene_01);
    ...
    private void initialize_mouse_controll(Smart_Group group_01, Scene scene_01) {
