...
public class TouristControls extends Behavior
{
    ...
    private final static int forwardKey = KeyEvent.VK_W;
    private final static int backKey = KeyEvent.VK_S;
    private final static int leftKey = KeyEvent.VK_A;
    private final static int rightKey = KeyEvent.VK_D;
