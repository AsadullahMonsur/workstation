...
public class Mykeynavbeh extends Applet implements KeyListener {
    ...
    private BranchGroup createCar() {
        ...
        t3d.setTranslation(new Vector3d(0.0, -0.125, 0.00001));
        t3d.setRotation(new AxisAngle4f(0.0f, 1.0f, 0.0f, 0.35f));
        t3d.setScale(.43);
         ...
         */
        String path3 = "F:\\model_3d\\three_D\\iron_man\\M-FF_iOS_HERO_Tony_Stark_Iron_Man_Civil_War\\M-FF_iOS_HERO_Tony_Stark_Iron_Man_Civil_War.obj";

        car = new MovingCar(path3);
        tg.addChild(car.tg);
    ...
    class MovingCar extends Behavior {
        ...
        public MovingCar(String filename) {
            ...
            ObjectFile loader = new ObjectFile(flags, (float)(creaseAngle*Math.PI)/180);
            Scene s = null;
        ...
        public void processStimulus(Enumeration criteria) {
            t3dstep.set(new Vector3d(0.0, 0.0, -0.0003f));
            tg.getTransform(t3d);
            t3d.mul(t3dstep);
            tg.setTransform(t3d);
